...
export function PracticeScreen() {
  ...
  // it only affects the very next question, not every future session.
  const goWithSkill = (skill: Skill) => () => {
    setPreferredSkill(skill);
    router.push("/session");
  };
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 18, flex: 1, paddingBottom: 100 }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
          <div className="el-tap" onClick={goWithSkill("speaking")} style={{ borderRadius: 20, padding: "16px 14px", background: theme.accentSoft, display: "flex", flexDirection: "column", gap: 8 }}>
